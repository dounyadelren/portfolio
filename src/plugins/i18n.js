  ...
  messages: {
    fr: {
      ...
      "web": {
        ...
        'food': "Ces prototypes ont été réalisés en s'inspirant d'un tutoriel Adobe XD, en utilisant seulement Figma"
      }
    },
    en: {
      'messages': {
      ...
      "web": {
        ...
        'food': "These prototypes were made based on an Adobe XD tutorial, but only using Figma."
      }
    }
  }
});
